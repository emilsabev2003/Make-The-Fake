...
/* Polish and Style:
Something intereting to note is that the game allows you to do multiple tricks in the air at once. The best one to do this with is the 360 side flip.
If you input the keys fast enough you can perform 3 in the air without crashing.
*/
